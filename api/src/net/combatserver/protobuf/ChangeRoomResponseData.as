package net.combatserver.protobuf {
	...
	public dynamic final class ChangeRoomResponseData extends com.google.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ROOM:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("net.combatserver.protobuf.ChangeRoomResponseData.room", "room", (1 << 3) | com.google.protobuf.WireType.LENGTH_DELIMITED, net.combatserver.protobuf.Room);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (room$count != 0) {
						throw new flash.errors.IOError('Bad data format: ChangeRoomResponseData.room cannot be set twice.');
					}
					++room$count;
