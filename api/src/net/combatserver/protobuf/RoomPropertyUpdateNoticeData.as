package net.combatserver.protobuf {
	...
	public dynamic final class RoomPropertyUpdateNoticeData extends com.google.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("net.combatserver.protobuf.RoomPropertyUpdateNoticeData.id", "id", (1 << 3) | com.google.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PROPERTIES:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("net.combatserver.protobuf.RoomPropertyUpdateNoticeData.properties", "properties", (2 << 3) | com.google.protobuf.WireType.LENGTH_DELIMITED, net.combatserver.protobuf.Property);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: RoomPropertyUpdateNoticeData.id cannot be set twice.');
					}
					++id$count;
