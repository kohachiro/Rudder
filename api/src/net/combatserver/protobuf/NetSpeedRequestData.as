package net.combatserver.protobuf {
	...
	public dynamic final class NetSpeedRequestData extends com.google.protobuf.Message {
		/**
		 *  @private
		 */
		public static const TIME:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("net.combatserver.protobuf.NetSpeedRequestData.time", "time", (1 << 3) | com.google.protobuf.WireType.VARINT);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (time$count != 0) {
						throw new flash.errors.IOError('Bad data format: NetSpeedRequestData.time cannot be set twice.');
					}
					++time$count;
