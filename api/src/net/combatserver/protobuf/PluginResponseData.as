package net.combatserver.protobuf {
	...
	public dynamic final class PluginResponseData extends com.google.protobuf.Message {
		/**
		 *  @private
		 */
		public static const DATA:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("net.combatserver.protobuf.PluginResponseData.data", "data", (1 << 3) | com.google.protobuf.WireType.LENGTH_DELIMITED, net.combatserver.protobuf.PluginData);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (data$count != 0) {
						throw new flash.errors.IOError('Bad data format: PluginResponseData.data cannot be set twice.');
					}
					++data$count;
