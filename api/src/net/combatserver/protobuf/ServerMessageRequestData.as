package net.combatserver.protobuf {
	...
	public dynamic final class ServerMessageRequestData extends com.google.protobuf.Message {
		/**
		 *  @private
		 */
		public static const MESSAGE:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("net.combatserver.protobuf.ServerMessageRequestData.message", "message", (1 << 3) | com.google.protobuf.WireType.LENGTH_DELIMITED);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (message$count != 0) {
						throw new flash.errors.IOError('Bad data format: ServerMessageRequestData.message cannot be set twice.');
					}
					++message$count;
