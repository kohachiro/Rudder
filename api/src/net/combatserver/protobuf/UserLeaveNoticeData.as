package net.combatserver.protobuf {
	...
	public dynamic final class UserLeaveNoticeData extends com.google.protobuf.Message {
		/**
		 *  @private
		 */
		public static const USERID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("net.combatserver.protobuf.UserLeaveNoticeData.userid", "userid", (1 << 3) | com.google.protobuf.WireType.VARINT);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (userid$count != 0) {
						throw new flash.errors.IOError('Bad data format: UserLeaveNoticeData.userid cannot be set twice.');
					}
					++userid$count;
