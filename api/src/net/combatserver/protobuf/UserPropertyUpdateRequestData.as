package net.combatserver.protobuf {
	...
	public dynamic final class UserPropertyUpdateRequestData extends com.google.protobuf.Message {
		/**
		 *  @private
		 */
		public static const PROPERTY:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("net.combatserver.protobuf.UserPropertyUpdateRequestData.property", "property", (1 << 3) | com.google.protobuf.WireType.LENGTH_DELIMITED, net.combatserver.protobuf.Property);
		...
		override public final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (property$count != 0) {
						throw new flash.errors.IOError('Bad data format: UserPropertyUpdateRequestData.property cannot be set twice.');
					}
					++property$count;
