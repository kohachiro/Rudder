...
public final class Main {
        ...
        private static void writeMessage(Scope<DescriptorProto> scope,
                ...
                content.append("\timport com.google.protobuf.*;\n");
                //content.append("\tuse namespace com.google.protobuf.used_by_generated_code;\n");
                content.append("\timport com.google.protobuf.fieldDescriptors.*;\n");
                ...
                content.append(" extends com.google.protobuf.Message");
                if (remoteClassAlias != null) {
                ...
                for (FieldDescriptorProto fdp : scope.proto.getFieldList()) {
                        ...
                        case LABEL_OPTIONAL:
                                ...
                                appendUpperCamelCase(content, fdp.getName());
                                content.append(") {\n");
                                content.append("\t\t\t\tcom.google.protobuf.WriteUtils.writeTag(output, com.google.protobuf.WireType.");
                                content.append(getActionScript3WireType(fdp.getType()));
                                content.append(", ");
                                content.append(Integer.toString(fdp.getNumber()));
                                content.append(");\n");
                                content.append("\t\t\t\tcom.google.protobuf.WriteUtils.write$");
                        ...
                        case LABEL_REPEATED:
                                if (fdp.hasOptions() && fdp.getOptions().getPacked()) {
                                        ...
                                        content.append("\t\t\t\tcom.google.protobuf.WriteUtils.writeTag(output, com.google.protobuf.WireType.LENGTH_DELIMITED, ");
                                        content.append(Integer.toString(fdp.getNumber()));
                                        content.append(");\n");
                                        content.append("\t\t\t\tcom.google.protobuf.WriteUtils.writePackedRepeated(output, com.google.protobuf.WriteUtils.write$");
                                        content.append(fdp.getType().name());
                                        content.append(", this.");
                                        appendLowerCamelCase(content, fdp.getName());
                                        content.append(");\n");
                ...
                content.append("\t\t\t\tvar tag:uint = com.google.protobuf.ReadUtils.read$TYPE_UINT32(input);\n");
                ...
                for (FieldDescriptorProto fdp : scope.proto.getFieldList()) {
                        ...
                        case LABEL_REQUIRED:
                                ...
                                if (fdp.getType() == FieldDescriptorProto.Type.TYPE_MESSAGE) {
                                        ...
                                        content.append(getActionScript3Type(scope, fdp));
                                        content.append("();\n");
                                        content.append("\t\t\t\t\tcom.google.protobuf.ReadUtils.read$TYPE_MESSAGE(input, this.");
                                        appendLowerCamelCase(content, fdp.getName());
                                        content.append(");\n");
                                } else {
                                        content.append("\t\t\t\t\tthis.");
                                        appendLowerCamelCase(content, fdp.getName());
                                        content.append(" = com.google.protobuf.ReadUtils.read$");
                                        content.append(fdp.getType().name());
                        ...
                        case LABEL_REPEATED:
                                switch (fdp.getType()) {
                                        ...
                                        case TYPE_SINT64:
                                        case TYPE_ENUM:
                                                content.append("\t\t\t\t\tif ((tag & 7) == com.google.protobuf.WireType.LENGTH_DELIMITED) {\n");
                                                content.append("\t\t\t\t\t\tcom.google.protobuf.ReadUtils.readPackedRepeated(input, com.google.protobuf.ReadUtils.read$");
                                                content.append(fdp.getType().name());
                                                content.append(", this.");
                                                appendLowerCamelCase(content, fdp.getName());
                                                content.append(");\n");
                                ...
                                if (fdp.getType() == FieldDescriptorProto.Type.TYPE_MESSAGE) {
                                        ...
                                        appendLowerCamelCase(content, fdp.getName());
                                        content.append(".push(");
                                        content.append("com.google.protobuf.ReadUtils.read$TYPE_MESSAGE(input, ");
                                        content.append("new ");
                                        content.append(getActionScript3Type(scope, fdp));
                                        content.append("()));\n");
                                } else {
                                        content.append("\t\t\t\t\tthis.");
                                        appendLowerCamelCase(content, fdp.getName());
                                        content.append(".push(com.google.protobuf.ReadUtils.read$");
                                        content.append(fdp.getType().name());
                                        content.append("(input));\n");
                                }
                                break;
        ...
        private static void appendFieldDescriptor(StringBuilder content,
                ...
                case LABEL_OPTIONAL:
                        content.append(Integer.toString(fdp.getNumber()));
                        content.append(" << 3) | com.google.protobuf.WireType.");
                        content.append(getActionScript3WireType(fdp.getType()));
                        break;
                case LABEL_REPEATED:
                        if (fdp.hasOptions() && fdp.getOptions().getPacked()) {
                                content.append(Integer.toString(fdp.getNumber()));
                                content.append(" << 3) | com.google.protobuf.WireType.LENGTH_DELIMITED");
                        } else {
                                content.append(Integer.toString(fdp.getNumber()));
                                content.append(" << 3) | com.google.protobuf.WireType.");
                                content.append(getActionScript3WireType(fdp.getType()));
        ...
        private static void writeEnum(Scope<EnumDescriptorProto> scope,
                ...
                content.append("\n\t\tpublic static function getName(enum:int):String { \n");
                content.append("\t\t\tswitch (enum){\n");
                for (EnumValueDescriptorProto evdp : scope.proto.getValueList()) {
                	content.append("\t\t\t\tcase ");
                	content.append(evdp.getName());
                	content.append(":\n");
